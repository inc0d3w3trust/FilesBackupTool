...
public class RestoreEntryModel implements Jsonable {
	...
	public void setisDeleteSource(boolean isDeleteSource) {
	...
	public String toString() {
		...
		stringBuilder.append("\t\t delete source(s) after backup - " + String.valueOf(isDeleteSource).toUpperCase());
	...
	public void toJson(Writer writable) throws IOException {
		...
		jsonObject.put("isDeleteSource", this.getisDeleteSource());
